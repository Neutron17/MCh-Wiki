    ...
    render() {
        return <div className={"bg-gradient-to-br from-indigo-500 via-purple-500 via-35% to-pink-500"} style={{color:'white'}}>
            ...
            <div className={"flex flex-wrap p-8 justify-center gap-16"}>
                ...
                <Category link={"/poems"} title={"Összes CsWM Vers"} description={"Összes CsWM vers"} img={uv1}/>
                ...
                <Category link={`/poem/${allPoems[Math.floor(Math.random()*allPoems.length)].title}`} title={"Random Vers"} description={"Random CsWM vers"} img={zephyr}/>
            </div>
        </div>;
    }
}
